...
This handbook is dedicated for the next Data Specialist taking over the position within the Public Health Unit in the Global Programmes department at HQ. The book dives into each aspect of the position, showcasing step by step guidance on how to run the existing tools and how to maintain them. 
...
# Main Groups to be part off

There are some groups that are interesting to be part off as the new Data person from PHU. 

- Data people HQ led by Giovanni Giuliari and Francesco Gizzarelli. This group includes all the data people from hq and discusses on a monthly basis ways of harmonizing data practices across different Global Program Units and Research Departments. 
- R CoP led by Yann Say. All R enthusiasts across Impact Initiatives Globally. 
...
However, here is the link to a draft I started called [impactR4PHU_WEBAPP](https://github.com/impact-initiatives/impactR4PHU_WEBAPP)

It does include three sections:

- **impactR4PHU Sectors Processes**: A section to run all sectors related quality/cleaning/analysis
- **IPHRA TOOL Builder**: A section to build the kobo tool for IPHRA, depending on opening/closing modules and selecting specific questions from core to supplementary ones. 
- **MSNA Integrated Tables**: A section to build the Public Health Integrated Tables for MSNA cross outcome indicators analysis

### Dependencies

Some of the projects included in the package have dependencies to other packages maintained by other Units within Impact Initiatives. 

- PH integrated tables project is dependent on **humind** maintained by HPPU. For any inquiry, contact Sunhee Moraes
- IPHRA FSL IPC Table output inside FSL Descriptive Analysis is dependent on **analysistools** & **presentresults** maintained by Yann Say. 
...
The cleaning mainly target the remote_moratlity_analysis data to prepare it for the Analysis. 
